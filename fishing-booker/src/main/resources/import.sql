...
insert into client (name, surname, address, city, country, email, password, explanation, penalty, number,points) values ('Madelon', 'Showler', '226 Mosinee Crossing', 'Kiruna', 'Sweden', 'mshowler4@chicagotribune.com', 'KebqbOYs8Zp', 'iaculis justo in hac', 0, '609-933-8055',5);
insert into client (name, surname, address, city, country, email, password, explanation, penalty, number,points) values ('Maryjo', 'Scopes', '7 Leroy Crossing', 'Karakulino', 'Russia', 'mscopes5@amazon.com', 'II2lgvQGJ0ii', 'consectetuer adipiscing elit proin', 2, '101-938-9772',5);
insert into client (name, surname, address, city, country, email, password, explanation, penalty, number,points) values ('Susette', 'Vondrach', '54539 Thompson Drive', 'Veyno', 'Belarus', 'svondrach6@webmd.com', 'PC247L', 'in tempor turpis nec euismod scelerisque quam', 2, '187-688-8289',5);
insert into client (name, surname, address, city, country, email, password, explanation, penalty, number,points) values ('Washington', 'Eggar', '24832 Katie Avenue', 'Sena Madureira', 'Brazil', 'maki2@gmail.com', '$2a$04$ukkSA8x5hr/LMuS7tQm48eqGg2Z1SG2/jBbOKjfA0Q9WHZ3qIx.Ee', 'eu orci mauris lacinia', 1, '200-105-3377',5);
insert into client (name, surname, address, city, country, email, password, explanation, penalty, number,points, activated, deleted) values ('Mladen', 'Pavlovic', 'Sajam', 'Novi Sad', 'Srbija', 'maki3@gmail.com', '$2a$04$a5w3BfZtlb81uQ/WPUgZb.bgFSrYdS8sKI6psdTu0OzFFiuvHdZ1y', 'eu orci mauris lacinia', 1, '200-105-3377' ,5,'true', 'false');

insert into cottage_owner (name, surname, address, city, country, email, password, explanation, number,activated,deleted) values ('Bev', 'Kumar', '404 Quincy Trail', 'Patrol', 'Indonesia', 'bkumar0@quantcast.com', 'A7fP2T', 'nullam sit amet turpis', '774-188-1464', 'false', 'false' );
insert into cottage_owner (name, surname, address, city, country, email, password, explanation, number,activated,deleted) values ('Damaris', 'Kamen', '7 Butternut Trail', 'Zhangdian', 'China', 'dkamen1@rakuten.co.jp', 'BuJdMYXzNoCh', 'faucibus orci luctus et ultrices posuere', '776-398-5991', 'false', 'false');
insert into cottage_owner (name, surname, address, city, country, email, password, explanation, number,activated,deleted) values ('Isidro', 'Lenchenko', '7346 Toban Alley', 'Longlisuo', 'China', 'ilenchenko2@netvibes.com', 'sFeTCgTOs9y6', 'sem duis aliquam convallis nunc', '378-695-9002', 'false', 'false');
