...
insert into client (name, surname, address, city, country, email, password, explanation, penalty, number, activated, deleted) values ('Mladen', 'Pavlovic', 'Sajam', 'Novi Sad', 'Srbija', 'maki3@gmail.com', '$2a$04$a5w3BfZtlb81uQ/WPUgZb.bgFSrYdS8sKI6psdTu0OzFFiuvHdZ1y', 'eu orci mauris lacinia', 1, '200-105-3377', 'true', 'false');
...
insert into cottage_owner (name, surname, address, city, country, email, password, explanation, number,activated,deleted) values ('Kip', 'Cheesman', '56475 Steensland Junction', 'Chagou', 'China', 'kcheesman6@furl.net', 'LEjMnSA2UZ0', 'diam in magna bibendum imperdiet nullam orci', '682-734-4013', 'false', 'false');
...
insert into boat_owner (name, surname, address, city, country, email, password, explanation, number, biography,activated,deleted) values ('Clevey', 'Couvert', '2 Bay Pass', 'Warlubie', 'Poland', 'ccouvert6@multiply.com', 'yfGmnnB3W7tQ', 'ut dolor morbi vel lectus', '160-137-8460', 'primis in faucibus orci luctus et ultrices', 'false', 'false');
