...
insert into boat_owner (name, surname, address, city, country, email, password, explanation, number, biography,activated,deleted) values ('Gabriel', 'Semmens', '7 Macpherson Crossing', 'Shchëkino', 'Russia', 'gsemmens0@baidu.com', '5Mza0z', 'nullam orci pede venenatis non', '564-182-4460', 'interdum venenatis turpis enim blandit mi in', 'false', 'false');
