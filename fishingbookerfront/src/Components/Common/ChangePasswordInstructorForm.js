...
export default function ChangePasswordInstructorForm({
  logedInstructor,
  changePasswordInstructorHandler,
}) {
  ...
  function saveHandler(e) {
    if (password.current.value != password1.current.value) {
      ...
      logedInstructor.password = password.current.value;

      changePasswordInstructorHandler(logedInstructor);
    }
  }
