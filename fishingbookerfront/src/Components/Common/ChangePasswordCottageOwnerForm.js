...
export default function ChangePasswordCottageOwnerForm({
  logedCottageOwner,
  ...
  function saveHandler(e) {
    if (password.current.value != password1.current.value) {
      ...
      logedCottageOwner.password = password.current.value;
      changePasswordHandler(logedCottageOwner);
    }
  }
          ...
          <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div className="card h-100">
              <div className="card-body">
                <div className="row gutters">
                  <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <h5 className="mb-2 text-primary">Change Password</h5>
                  </div>
