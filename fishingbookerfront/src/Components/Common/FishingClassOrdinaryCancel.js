...
import fishingQuickReservationServices from "../../Services/FishingClassQuickReservationServices/FishingClassQuickReservationServices";
import {
  Card,
  ListGroup,
  ListGroupItem,
                      ...
                      >
                       ...
                       onClick={() =>{
                        ...
                        if((date.getTime()-today.getTime())/(1000 * 3600 * 24)>3){
                            fishingQuickReservationServices.DELFishingClassOrdinaryReservation(reservation.id);
