...
import cottageServices from "../../Services/CottageQuickReservationServices/CottageQuickReservationServices";
...
export default function CurrentReservations({ currentReservations}) {
  ...
  const [cant2, setCant] = useState(JSON.parse(localStorage.getItem("cant2")))
  ...
  function forbidde(fishing) {
    ...
    setCant(newFishing)
    localStorage.setItem("cant2", JSON.stringify(newFishing));
  }
    ...
    <div>
      <div className="App">
        <div className="header">
          <h1 style={{ textAlign: "center" }}> Book cottages </h1>
        </div>
                    ...
                    <Card className="cardContainer" style={{ width: "30rem" }}>
                      ...
                      <Card.Body>
                        ...
                        <Button onClick={()=>{
                                ...
                                reservationObject.cottage=reservation;
                                cottageServices.createCottageReservation(reservationObject);
                                alert("Uspesno");
