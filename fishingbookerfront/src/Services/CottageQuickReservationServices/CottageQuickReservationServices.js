...
//client--------------------------------------------------------------------------------------
  ...
  DELCottageQuickReservation: (CottageQuickReservationId ) => {
    return axios.delete(
      `${process.env.REACT_APP_API_URL}cottageQuickReservations/${CottageQuickReservationId}`
      
    );
  },

  DELCottageOrdinaryReservation: (CottageQuickReservationId ) => {
    return axios.delete(
      `${process.env.REACT_APP_API_URL}cottageReservations/${CottageQuickReservationId}`
